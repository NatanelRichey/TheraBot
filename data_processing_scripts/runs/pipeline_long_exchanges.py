#!/usr/bin/env python3
"""
Run 3: Complete pipeline with long exchanges
50% 12 exchanges, 25% 17 exchanges, 15% 18 exchanges, 10% 20 exchanges
"""
...
def main():
    """Main function for Run 3."""
    
    # Run 3 configuration
    run_name = "run3_long"
    exchange_distribution = {
        12: 0.50,  # 50% - 12 exchanges
        17: 0.25,  # 25% - 17 exchanges
        18: 0.15,  # 15% - 18 exchanges
        20: 0.10   # 10% - 20 exchanges
    }
    
    input_dir = "../data/transcripts_json"
    base_output_dir = "../data/processed"
    
    print("RUN 3: LONG EXCHANGES")
    print("Distribution: 50% 12 exchanges, 25% 17 exchanges, 15% 18 exchanges, 10% 20 exchanges")
